...
module.exports = function cleanSequenceData(seqData, options={}) {
    //console.log('CLEANING SEQ DATA');
    ...
    userDefinedTypes.forEach(function(annotationType){
        ...
        Object.keys(annotations).forEach(function(key){
            ...
            var cleanedAnnotation = cleanUpAnnotation(annotation, options)
    ...
    if (options.logMessages) {
        //console.log('sequence parsing messages: ', response);
    }
